            ...
            <div class="row">
                <div class="col-lg-4 text-center">
                    <div class="chancellor_leftcol">
                        <div class="row">
                            <div class="col-lg-12"><img src="{{ asset('assets/images/innerpages/about/RamakrishnanRaman.png') }}" style="border-radius: 20px;" class="img-fluid"></div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12" style="justify-content: center;display: flex;"><div class="chancellor_title">Vice Chancellor</div></div>
                            <div class="col-lg-12 chancellor_head mb-2">Dr Ramakrishnan Raman</div>
                            <div class="col-lg-12 chancellor_content">Vice Chancellor, Symbiosis International (Deemed University)</div>
                        </div>
                        <div class="row">
